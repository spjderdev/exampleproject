...
<header class="header sticky top-0 bg-customBlack flex items-center justify-between px-8 py-02 shadow-2xl">
    ...
    <div class="w-3/12 flex justify-end">
        ...
        <a href="index.php?controller=pages&action=signin" class="bg-redCustom uppercase text-white h-8 p-4 flex items-center justify-center ml-1  duration-200 font-bold">
    Sign in
</a>
